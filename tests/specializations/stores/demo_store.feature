Feature: Store
  ...
  Scenario: The registration of a resource succeeds.
    ...
    And The report should say that the operation was '_register'.
  ...
  Scenario: The registration of a resource fails.
    ...
    When I register the resource. The printed report does mention an error: 'resource already exists'.
    ...
    And The report should say that the error was 'resource already exists'.

  Scenario: The registration of resources fails.
    Given A store instance.
    And Already registered resources.
    When I register the resources. The printed report does mention an error: 'resource already exists'.
