Feature: Model
  ...
  Scenario: The validation of a resource fails.
    ...
    When I validate the resource. The printed report does mention an error: 'name is missing'.
  ...
  Scenario: The validation of resources fails.
    ...
    When I validate the resources. The printed report does mention an error: 'name is missing'.
