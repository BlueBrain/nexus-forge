...
class TestMapper:
    ...
    def test_apply_on_one(self, mocker, mapper, json_record):
        ...
        Mapper.map_one.assert_called_once()
    ...
    def test_apply_on_many(self, mocker, mapper, json_records):
        ...
        Mapper.map_many.assert_called_once()
